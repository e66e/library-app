...
const SearchBooksPage = () => {
  ...
  const [categorySelection, setCategorySelection] = useState("Book categeory");
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      if (!response.ok) {
        throw new Error("Something went wrong while fetching info!");
      }
        ...
        <div>
          ...
          {totalAmountOfBooks > 0 ? (
            ...
            <div className="m-5">
              ...
              <a
                type="button"
                className="btn btn-primary main-color  btn-md px-4 me-md-2 fw-bold text-white"
                href="#"
              >
                Library Services
              </a>
